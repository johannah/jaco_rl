...
def pca_plot(X, images, color, serve_port=8104, html_out_path='mpld3.html', serve=False, img_size=(80,80)):
    ...
    for nidx in range(images.shape[0]):
        ...
        ax.imshow(resize(images[nidx], img_size))
...
def tsne_plot(X, images, color, perplexity=5, serve_port=8104, html_out_path='mpld3.html', serve=False, img_size=(80,80)):
